          ...
          <div className="content-container">
            ...
            <FadeInOnScroll delay={100}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-5xl mx-auto mb-24">
                ...
                <div className="space-y-10">
                  {/* GitHub */}
                  <div className="group">
                    <h3 className="text-white text-[20px] font-bold mb-3 tracking-wide">GitHub</h3>
                    <a 
                      href="https://github.com/Jasper-van-Tilborg" 
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#AA61FF] text-[18px] hover:text-[#8844FF] transition-all duration-300 underline decoration-[#AA61FF]/50 hover:decoration-[#8844FF] inline-flex items-center gap-2 group-hover:gap-3"
                    >
                      https://github.com/Jasper-van-Tilborg
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="opacity-70 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* LinkedIn */}
                  <div className="group">
                    <h3 className="text-white text-[20px] font-bold mb-3 tracking-wide">LinkedIn</h3>
                    <a 
                      ...
                      className="text-[#AA61FF] text-[18px] hover:text-[#8844FF] transition-all duration-300 underline decoration-[#AA61FF]/50 hover:decoration-[#8844FF] inline-flex items-center gap-2 group-hover:gap-3"
                    >
                      https://www.linkedin.com/in/jasper-van-tilborg
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="opacity-70 group-hover:opacity-100 transition-opacity">
                ...
                <div className="space-y-10">
                  {/* Email */}
                  <div className="group">
                    <h3 className="text-white text-[20px] font-bold mb-3 tracking-wide">Email</h3>
                    <a 
                  ...
                  {/* Discord */}
                  <div className="group">
                    <h3 className="text-white text-[20px] font-bold mb-3 tracking-wide">Discord</h3>
                    <button
                      onClick={handleCopyDiscord}
                      className="text-[#AA61FF] text-[18px] hover:text-[#8844FF] transition-all duration-300 underline decoration-[#AA61FF]/50 hover:decoration-[#8844FF] cursor-pointer text-left inline-flex items-center gap-2 group-hover:gap-3"
                    >
                      @.grobbel
            ...
            <FadeInOnScroll delay={200}>
              <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-[#0a0a1e] border-2 border-[#AA61FF]/30 rounded-2xl p-8 hover:border-[#AA61FF] transition-all duration-300 mt-8">
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button
                      ...
                      className="w-full px-8 py-4 bg-[#AA61FF] text-white font-semibold rounded-lg hover:bg-[#8844FF] transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
